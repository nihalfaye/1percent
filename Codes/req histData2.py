...
try : 
    historical_data3 = histdata("https://www.nseindia.com/api/historical/indicesHistory?indexType=NIFTY FINANCIAL SERVICES&from="+OneYearAgo+"&to=" + today)
    historical_data4 = histdata("https://www.nseindia.com/api/historical/indicesHistory?indexType=NIFTY MIDCAP SELECT&from="+OneYearAgo+"&to=" + today)

    histdata_sheet.range("M3").value = historical_data3.values
    histdata_sheet.range("S3").value = historical_data4.values
